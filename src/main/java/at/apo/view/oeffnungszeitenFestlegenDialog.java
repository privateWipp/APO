...
public class oeffnungszeitenFestlegenDialog extends Dialog<HashMap<String, String>> {
    ...
    public oeffnungszeitenFestlegenDialog(Apotheke model, boolean change) {
        ...
        setTitle("Öffnungszeiten festlegen : " + this.model.getName());
        ...
        this.setResultConverter(bt -> {
            if (bt == buttonType) {
                try {
                    ...
                    errorAlert.setHeaderText("Fehler beim Festlegen der Öffnungszeiten für die Apotheke " + this.model.getName());
