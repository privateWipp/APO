...
public class geschaeftsfuehrerAnzeigen extends BorderPane {
    ...
    private void initGUI() {
        this.stage.setTitle("Informationen zu Geschäftsführer " + this.model.getGeschaeftsfuehrer().getVorname() + " " + this.model.getGeschaeftsfuehrer().getNachname() + " : " + this.model.getName());
